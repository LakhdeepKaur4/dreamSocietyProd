            ...
            "Messages": [
                {
                    ...
                    "HTMLPart": `<b>Click on the given link to activate your account</b> <a href="http://192.168.1.107:3000/login/tokenVerification?individualVendorId=${individualVendorId}&token=${token}">click here</a>`
                }
            ]
        })
    request.then((result) => {
