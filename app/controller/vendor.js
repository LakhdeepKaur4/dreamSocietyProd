...
exports.updateVendorService = async (req, res, next) => {
    try {
        ...
        let ups = await VendorService.findOne({ where: { isActive: true, serviceId: req.body.serviceId, rateId: req.body.rateId, rate:req.body.rate, vendorId: req.body.vendorId } });
        if (ups) {
